 ...
 */
UMAbcScenePtr UMAbcIO::load(umstring path, const UMAbcSetting& setting)
{
 ...
 * save 3d file
 */
bool UMAbcIO::save(umstring path, UMAbcScenePtr scene, const UMAbcSetting& setting)
{
 ...
 */
void UMAbcIO::convert_abc_mesh_ccw_to_cw(umabc::UMAbcObjectPtr src)
{
